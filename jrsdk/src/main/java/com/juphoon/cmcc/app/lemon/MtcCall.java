 ...
 * @see @ref MtcCall::Mtc_SessAnswer, @ref MtcCall::Mtc_SessGetCookie, @ref MtcCall::Mtc_SessSetCookie
 */
  public static int Mtc_SessRadioCall(String pcUri, Object zCookie, boolean bAudio, boolean bVideo, int iServInfoType) {
    return MtcCallJNI.Mtc_SessRadioCall(pcUri, zCookie, bAudio, bVideo, iServInfoType);
  }
